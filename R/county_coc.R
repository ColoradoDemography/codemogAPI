#' API Wrapper to call Colorado County Components of Change Data
#'
...
#' @param year_list Numeric list of years between 1970 and 2050
#' @param group string taking values of opt1, opt2 see descriptiong what what each does
...
county_coc = function(fips_list, year_list, group="none"){
  # subject to change, but this is the server URL
  url_stub = "https://gis.dola.colorado.gov/lookups/components?"
  ...
  # together for call
  suppressWarnings(if (fips_list == 300) {
