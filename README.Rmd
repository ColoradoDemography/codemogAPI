...
In this example we will pull the population estimate for the counties in the Denver MSA and then combine them into a total Denver MSA estimate for 2014 to append to the .
...
msa_total=as.data.frame(sum(msa_counties$totalPopulation) # creates a data frame with the total population of the MSA
